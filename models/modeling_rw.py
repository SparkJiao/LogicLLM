...
# NOTE(Hesslow): Unfortunately we did not fuse matmul and bias during training,
# this means that there's one additional quantization to bfloat16 between the operations.
